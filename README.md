...
O sistema deve permitir cadastrar usuários informando nome e e-mail.

### RF2 — Cadastrar Prato

O sistema deve permitir que um usuário cadastre um prato informando nome, descrição, preço e categoria.
